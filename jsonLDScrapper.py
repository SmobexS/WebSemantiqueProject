...
class JsonLDScraper:
    ...
    def scrapper(self,json_file) :
        ...
        for coop_restaurants_url in coops_restaurants_urls:
            ...
            coop_url = self.parse_url(coop_restaurants_url)
            coop_url_contry = self.parse_url_contry(coop_restaurants_url)
